...
import com.imooc.cloud.mall.practice.cartorder.utils.OrderCodeFactory;
...
//        throw new ImoocMallException(ImoocMallExceptionEnum.NOT_SALE);
     ...
     */
    @Override
    public void cancel(String orderNum, Boolean isFromSystem) {
        //首先，根据传过来的订单号，去查订单；
...
//        String address = ip + ":" + request.getLocalPort();
        ...
        try {
            QRCodeGenerator.generateQRCode(payUrl, 350, 350, FILE_UPLOAD_DIR + orderNo + ".webp");
        ...
        String pngAddress = "http://" + address + "/cart-order/images/" + orderNo + ".webp";
        //然后，把这个二维码图片的访问地址返回；
        return pngAddress;
    }
    ...
    public void finish(String orderNo) {
        ...
        if(UserInfoFilter.userThreadLocal.get().getRole().equals(1)&&!order.getUserId().equals(
                UserInfoFilter.userThreadLocal.get().getId()
        )){
            throw new ImoocMallException(ImoocMallExceptionEnum.NOT_YOUR_ORDER);
        }
